...
Kon_c = 1e-05;          %on binding in cell cytosol in [1/s].
Koff_c = 1e-02;         %off binding in cell cytosol in [1/s].
Kon_m =  1e-05;         %on binding in cell mitochondria in [1/s].
Koff_m = 1e-03;         %off binding in cell mitochondria in [1/s].
delta = 1e+8;           %determines the effect of mitochondrial binding on mitochondrial membrane potential
N = 4;                  %Hill coefficent
K = 4e-8;               %dissoication constant 
K2 = 1e-10;             %dissoication constant 
